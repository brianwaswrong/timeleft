...
export default function ConciergeOverlay({
  mode = 'planner', // "planner" | "feedback" | "general_assistant"
  open = false,
  onClose = () => {},
  ...
  const flows = useMemo(
    () => ({
      planner: [
        {
          role: 'assistant',
          text: "Hey Maxime, how's your week shaping up? Anything we can help plan?",
          chips: [
      ...
      feedback: [
        {
          role: 'assistant',
          text: 'How did everything go? Any great conversation or connection?',
          chips: [
            'Really vibed at some points!',
            'Went alright',
            'Didn’t click',
            'Left early',
          ],
        ...
        {
          role: 'assistant',
          text: 'Gotcha. Anyone you want to see again? For what?',
          chips: [
            'Oliver',
            'Brian',
            'Isaure',
      ...
      general_assistant: [
        {
          role: 'assistant',
          text: 'How can I help, Max?',
          chips: [
            'Find people for salsa',
            'Need musicians to jam with',
            'Meet others different from me',
        ...
        {
          role: 'assistant',
          text: "Awesome, let's find some people for that first step. What kind of commitment are you looking for?",
          chips: [
            'Test the waters: One-Time / Drop-In',
            'Short-Term: 4-8 Weeks',
            "I'm serious: 8-12 weeks",
          ],
          placeholder: 'Optional: who & why?',
        },
        {
          role: 'assistant',
          text: "Got it. We'll make sure you find the right group to tackle this seriously. Anything else?",
          chips: ['Done'],
        },
      ],
    }),
  ...
  return (
    ...
    >
      ...
      >
        <div className="w-full max-w-xl h-[80vh] rounded-2xl border border-white/10 bg-white/[.04] text-white shadow-2xl flex flex-col relative md:h-[76vh]">
          {/* Close */}
          <button
